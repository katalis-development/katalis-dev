<template>
  ...
  >
    ...
    >
      ...
      <a href="#services" class="hover:text-blue-400 font-bold transition"
        >Services</a
      >
      <a href="#about" class="hover:text-blue-400 font-bold transition"
        >About</a
      >
      <a href="#contact" class="hover:text-blue-400 font-bold transition"
        >Contact</a
      >
    </div>
  </nav>
