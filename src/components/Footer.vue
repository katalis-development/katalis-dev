      ...
      <div class="relative z-10 max-w-7xl mx-auto text-center">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div class="flex flex-col items-center">
            <h3 class="text-2xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-sky-300">
              Katalis Dev
            </h3>
          ...
          <!-- Social Media -->
          <div class="flex flex-col items-center">
            <h4 class="text-lg font-semibold mb-4 text-gray-300">Follow Us</h4>
